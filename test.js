            ...
            connect(distanceMax) {
                ...
                for (var i = 0; i < this.length - 1; i++) {
                    ...
                    for (var k = 0; k < this.nodes[i].connections.length; k++) {
                        context.beginPath();
                        context.moveTo(this.nodes[i].x + 0.5, this.nodes[i].y + 0.5);
                        context.lineTo(this.nodes[this.nodes[i].connections[k]].x + 0.5, this.nodes[this.nodes[i].connections[k]].y + 0.5);
